...
این کل وب‌سایت با یک **پرامپت** و کمک دستیار هوش مصنوعی ساخته شده است. من آن پرامپت را
در فولدر مخصوص خودش قرار داده‌ام تا بتوانید از آن یاد بگیرید و استفاده کنید:

> 📄 **[`prompt/arkan-website-prompt.md`](prompt/arkan-website-prompt.md)**

داخل این فایل، **همان پرامپتی** که برای ساخت این پروژه استفاده شد به‌طور کامل آمده است،
به‌همراه توضیح این‌که چه چیزی آن را به یک پرامپت خوب تبدیل می‌کند.

**چطور از آن استفاده کنید:**

1. فایل پرامپت را در فولدر [`prompt/`](prompt/) باز کنید و بخوانید.
2. دو سند مرجع پروژه را با اطلاعات کسب‌وکار خودتان جایگزین کنید:
   - [`arkan-client-brief.md`](arkan-client-brief.md) — پروفایل کسب‌وکار، خدمات، محتوا
   - [`arkan-brand-guide.md`](arkan-brand-guide.md) — رنگ‌ها، فونت‌ها، لحن برند
